"""
Heroku-specific Django settings for Kenyan Payroll Management System
"""
...
SECRET_KEY = config('SECRET_KEY', default='django-insecure-heroku-change-this-in-production')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = config('DEBUG', default=False, cast=bool)

# Heroku provides the host
ALLOWED_HOSTS = [
    '.herokuapp.com',
    'localhost',
    '127.0.0.1',
